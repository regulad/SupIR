...
Almost all non-trivial (>= 10 SLoC) portions MakeHex code present in this project have been reimplemented using MakeHex's original source, its behavior, and other reference materials as reference. While the MakeHex license *should* be GPLv3-compatible since it permits redistribution, the original license of MakeHex is included below for the sake of completeness and courtesy to [`probononpd`](https://github.com/probonopd). 
